...
static void CG_CalcIdealThirdPersonViewTarget(void)
{
	...
	//CG_CenterPrint( va("%i %i %i",cg.snap->ps.stats[STAT_EXTRA_FORCE_BITS2],cg.snap->ps.stats[STAT_EXTRA_FORCE_BITS],
	//	cg.snap->ps.fd.forcePowerLevel[FP_SEE]),SCREEN_HEIGHT * 0.30, BIGCHAR_WIDTH );
