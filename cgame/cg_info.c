...
//	CG_DrawLoadingIcons();
	...
	if ( cg.infoScreenText[0] ) {
		...
		//RoboPhred
		UI_DrawProportionalString( 320, 128-32, (const char *)va(/*"Loading... %s"*/ (char *)psLoading, cg.infoScreenText),
		//UI_DrawProportionalString( 320, 128-32, (const char *)va(/*"Loading... %s"*/ psLoading, cg.infoScreenText),
