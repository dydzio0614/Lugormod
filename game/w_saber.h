...
//Creator: Updated Macros For Force Distance.
#define	FORCE_POWER_MAX	100
#define MAX_GRIP_DISTANCE_LV1 256
#define MAX_GRIP_DISTANCE_LV2 320
#define MAX_GRIP_DISTANCE_LV3 384
#define MAX_GRIP_DISTANCE_LV4 512
#define MAX_GRIP_DISTANCE_LV5 768
#define MAX_TRICK_DISTANCE 512
#define FORCE_JUMP_CHARGE_TIME 6400//3000.0f
#define GRIP_DRAIN_AMOUNT 30
#define FORCE_LIGHTNING_RADIUS_LV1 2048
#define FORCE_LIGHTNING_RADIUS_LV2 2048
#define FORCE_LIGHTNING_RADIUS_LV3 300
#define FORCE_LIGHTNING_RADIUS_LV4 450
#define FORCE_LIGHTNING_RADIUS_LV5 600
...
extern int forcePowerNeeded[NUM_FORCE_POWER_LEVELS + 2][NUM_FORCE_POWERS];
extern float forceJumpHeight[NUM_FORCE_POWER_LEVELS + 2];
extern float forceJumpStrength[NUM_FORCE_POWER_LEVELS + 2];
extern float forcePushPullRadius[NUM_FORCE_POWER_LEVELS + 2];
