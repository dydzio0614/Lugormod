...
#define FORCEJUMP_INSTANTMETHOD 1 //Lugormod it should be instant right??
...
#define SABER_ATTACK_RANGE			256 //128
...
typedef struct bot_state_s
{
	...
	float				meleeStrafeDisable;
        float                           meleeApproachTime;
        int                                     meleeApproachDir;
        float                           meleeApproachDisable;
