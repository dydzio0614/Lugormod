...
//RoboPhred
//TODO: copy over dynamic loading code
...
//===TURRETS===========================================================================
	...
	{"turret1InvertYawAxis", VFOFS(turret[0].invYawAxis), VF_INT},
	{"turret1PitchAxis", VFOFS(turret[0].pitchAxis), VF_INT},
	{"turret1InvertPitchAxis", VFOFS(turret[0].invPitchAxis), VF_INT},
	...
	{"turret2InvertYawAxis", VFOFS(turret[1].invYawAxis), VF_INT},
	{"turret2PitchAxis", VFOFS(turret[1].pitchAxis), VF_INT},
	{"turret2InvertPitchAxis", VFOFS(turret[1].invPitchAxis), VF_INT},
...
{
        //int index = VEH_VehicleIndexForName( vehicleName );
        //Com_Printf("info: Index %i %s\n", index, vehicleName);
        //return index;
